...
public class LoginPresenter extends UserPresenter implements ILoginPresenter {
    ...
    private void authenticateUser(String username, String password) {
        ...
        }, throwable -> mvpView.showMessage(RetrofitService.convertThrowableToHttpMessage(throwable)));
    }
}
